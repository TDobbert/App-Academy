...
def craiglockhart_to_sighthill
  ...
  execute(<<-SQL)
    ...
    JOIN
      stops AS og_stops ON start.stop_id = og_stops.id
    JOIN
      stops AS dest_stops ON finish.stop_id = dest_stops.id
    WHERE
      og_stops.name = 'Craiglockhart' AND dest_stops.name = 'Sighthill'
